...
<div class="container" >
	<div class="row">
		<div class="">
			...
			<div class="form-group">
  				...
  				<input type="text" name="recname" class="form-control" placeholder="*Please Enter Recipient's Name*">
  			</div>	
  			<div class="form-group">
  				<label>Enter ID/Birth Certificate (Optional If Not Available)</label>
  				<input type="text" name="recidno" class="form-control" placeholder="*Please Enter Recipient's ID/Birth Cert Number*">
  			</div>
	<div class="hiddenElements">
		<div class="form-group">
			<label>Select Blood Type</label>
			<select class="form-control" id="selectBloodType" name="recbloodType">
				<option name = "bloodTypeOption" value="default">*Fill in the Recipient's Blood Type*</option>
  ...
  <select class="form-control" name="reccounty" id="continent" onchange="countryChange(this);">
  ...
  <div class="form-group">
  	...
  	<select class="form-control" name="recsubcounty" id="subcounty">
    	<option value="0">*Please Select The Recipient's County To Access This Option*</option>
  	</select>
  </div>
  
  <div class="form-group">
  	<input type="submit" name="recsubmit" value="Submit"  class="btn btn-info btn-lg" />
  </div>	
</div>
</form>
		</div>
...
<script>
 ...
 countryLists["empty"] = ["*Please Select The Recipient's County To Access This Option*"]; 
